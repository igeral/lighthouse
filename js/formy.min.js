function validate(e) {
  return (
    e.stopPropagation(),
    e.preventDefault(),
    nameField.hasAttribute("required") && nameField.value.length < 3
      ? (nameField.focus(),
        (passedValidation = !1),
      ...
      : ($(nameField).prev().children().removeClass("invalid"),
        ...
        (passedValidation = !0),
        emailField.hasAttribute("required") && emailField.value.length < 5
          ? (emailField.focus(),
            (passedValidation = !1),
          ...
          : ($(emailField).prev().children().removeClass("invalid"),
            ...
            (passedValidation = !0),
            phoneField.hasAttribute("required") && phoneField.value.length < 9
              ? (phoneField.focus(),
                (passedValidation = !1),
              ...
              : ($(phoneField).prev().children().removeClass("invalid"),
                ...
                (passedValidation = !0),
                messageField.hasAttribute("required") &&
                messageField.value.length < 12
                  ? (messageField.focus(),
...
$(document).ready(function () {
    ...
    $(phoneField).keydown(function (e) {
      ...
      return (
        ...
        8 !== a &&
          ...
          0 === $phone.val().length && $phone.val($phone.val() + "+"),
          2 === $phone.val().length && $phone.val($phone.val() + " ("),
          7 === $phone.val().length && $phone.val($phone.val() + ") "),
          12 === $phone.val().length && $phone.val($phone.val() + "-"),
          15 === $phone.val().length && $phone.val($phone.val() + "-")),
        8 !== a &&
          9 !== a &&
          "3" == char &&
          ($phone.attr("maxlength", "19"),
          0 === $phone.val().length && $phone.val($phone.val() + "+"),
          3 === $phone.val().length && $phone.val($phone.val() + " ("),
          8 === $phone.val().length && $phone.val($phone.val() + ") "),
          13 === $phone.val().length && $phone.val($phone.val() + "-"),
          16 === $phone.val().length && $phone.val($phone.val() + "-")),
        8 == a ||
          9 == a ||
          46 == a ||
          (a >= 48 && a <= 57) ||
  ...
  $("#formy").submit(function (e) {
    ...
    if (passedValidation) {
      ...
      (a = $.ajax({ url: "/php/formy.php", type: "post", data: l })),
        a.done(function (e, a, l) {
          $("#result").removeClass("invalidRequest"),
            ...
            $("#result").show().delay(5e3).fadeOut("slow"),
            $("#formy")[0].reset();
        }),
        a.fail(function () {
